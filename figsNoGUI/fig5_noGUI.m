...
% RF parameters:
% C/S size ratio: 0.8 to {N/A, 3, 4.7, 5.2, 5.5, 5,7} deg (resulting center frequencies: 0 for 0 surround amplitude, 0.08 cpd otherwise)
% surround amplitude: {0, 0.2, 0.4, 0.6, 0.8, 1}
...
% c/s ratio: 0.8 to N/A deg, surround amp: 0
%{ %
% dataFile = "rfGaborSimData_24-12-16_1131.mat"; % 0.01 cpd, 30 deg radius circle
% dataFile = "rfGaborSimData_24-12-16_1134.mat"; % 0.02 cpd, 30 deg radius circle
% dataFile = "rfGaborSimData_24-12-16_1138.mat"; % 0.04 cpd, 30 deg radius circle
% dataFile = "rfGaborSimData_24-12-16_1141.mat"; % 0.08 cpd, 30 deg radius circle
% dataFile = "rfGaborSimData_24-12-16_1145.mat"; % 0.16 cpd, 30 deg radius circle
% dataFile = "rfGaborSimData_24-12-16_1148.mat"; % 0.32 cpd, 30 deg radius circle
%}

% c/s ratio: 0.8 to 3 deg, surround amp: 0.2
%{ % 
% dataFile = "rfGaborSimData_24-12-12_1351.mat"; % 0.01 cpd, 30 deg radius circle
% dataFile = "rfGaborSimData_24-12-11_1311.mat"; % 0.02 cpd, 30 deg radius circle
% dataFile = "rfGaborSimData_24-12-11_1315.mat"; % 0.04 cpd, 30 deg radius circle
% dataFile = "rfGaborSimData_24-12-11_1319.mat"; % 0.08 cpd, 30 deg radius circle
% dataFile = "rfGaborSimData_24-12-12_1356.mat"; % 0.16 cpd, 30 deg radius circle
% dataFile = "rfGaborSimData_24-12-12_1400.mat"; % 0.32 cpd, 30 deg radius circle
%}

% c/s ratio: 0.8 to 4.7 deg, surround amp: 0.4
%{ % 
...
% c/s ratio: 0.8 to 5.2 deg, surround amp: 0.6
%{ % 
% dataFile = "rfGaborSimData_24-12-12_1404.mat"; % 0.01 cpd, 30 deg radius circle
% dataFile = "rfGaborSimData_24-12-11_1335.mat"; % 0.02 cpd, 30 deg radius circle
% dataFile = "rfGaborSimData_24-12-11_1338.mat"; % 0.04 cpd, 30 deg radius circle
% dataFile = "rfGaborSimData_24-12-11_1342.mat"; % 0.08 cpd, 30 deg radius circle
% dataFile = "rfGaborSimData_24-12-12_1408.mat"; % 0.16 cpd, 30 deg radius circle
% dataFile = "rfGaborSimData_24-12-12_1412.mat"; % 0.32 cpd, 30 deg radius circle
%}

% c/s ratio: 0.8 to 5.5 deg, surround amp: 0.8
%{ % 
% dataFile = "rfGaborSimData_24-12-12_1449.mat"; % 0.01 cpd, 30 deg radius circle
% dataFile = "rfGaborSimData_24-12-12_1453.mat"; % 0.02 cpd, 30 deg radius circle
% dataFile = "rfGaborSimData_24-12-12_1457.mat"; % 0.04 cpd, 30 deg radius circle
% dataFile = "rfGaborSimData_24-12-12_1500.mat"; % 0.08 cpd, 30 deg radius circle
% dataFile = "rfGaborSimData_24-12-12_1504.mat"; % 0.16 cpd, 30 deg radius circle
% dataFile = "rfGaborSimData_24-12-12_1508.mat"; % 0.32 cpd, 30 deg radius circle
%}

% c/s ratio: 0.8 to 5.7 deg, surround amp: 1
%{ % 
% dataFile = "rfGaborSimData_24-12-12_1512.mat"; % 0.01 cpd, 30 deg radius circle
% dataFile = "rfGaborSimData_24-12-12_1518.mat"; % 0.02 cpd, 30 deg radius circle
% dataFile = "rfGaborSimData_24-12-12_1522.mat"; % 0.04 cpd, 30 deg radius circle
% dataFile = "rfGaborSimData_24-12-12_1526.mat"; % 0.08 cpd, 30 deg radius circle
% dataFile = "rfGaborSimData_24-12-12_1529.mat"; % 0.16 cpd, 30 deg radius circle
% dataFile = "rfGaborSimData_24-12-12_1533.mat"; % 0.32 cpd, 30 deg radius circle
%}
