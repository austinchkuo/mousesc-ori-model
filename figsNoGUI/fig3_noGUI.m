...
% RF parameters:
% C/S size ratio: 1.5 : 11.4 deg (resulting center frequency: 0.04 cpd)
% surround amplitude: 0.8
...
dirstring = "~/Documents/MATLAB/rfSimData/fig3/";
dataFile = "rfGaborSimData_25-01-22_1140.mat";
% data for figure 3
% dataFile = "rfGaborSimData_25-01-21_1700.mat"; % 20 deg radius circle
% dataFile = "rfGaborSimData_25-01-22_1140.mat"; % 30 deg radius circle
% dataFile = "rfGaborSimData_25-01-22_1212.mat"; % 40 deg radius circle
% dataFile = "rfGaborSimData_25-01-22_1232.mat"; % 40 deg side length (i.e., 20 deg radius) square
% dataFile = "rfGaborSimData_25-01-22_1245.mat"; % 40 deg side length diamond
...
%% plotting
% plots the orientation preference maps in figure 3 (depending on loaded on stimulus file)
